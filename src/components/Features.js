      ...
      <div className="contentBg px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="flex flex-col mb-6 lg:flex-row md:mb-10">
          <div className="lg:w-1/2">
            <h2 className="customTextColor max-w-md mb-6 font-sans text-3xl font-bold tracking-tight  sm:text-4xl sm:leading-none xl:max-w-lg">
              Projects
            </h2>
          </div>
        </div>
        <div className="grid gap-8 row-gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div className="max-w-md">
            <div className="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50">
              <svg
                className="w-12 h-12 customTextColor"
                stroke="currentColor"
                viewBox="0 0 52 52"
              >
                <polygon
